...
public class AutoRocketFar extends CommandGroup {
	public AutoRocketFar(boolean mirrored) {
		...
		addSequential(new DriveMotionProfile("backwards_to_far_rocket", true));
		...
		addSequential(new DriveTurnToAngleWithEncoders(true ? 57 : -57, 14, 10));
		addSequential(new DriveMotionProfile("back_rocket_to_wall", true));
		addSequential(new DriveAutoConfirm());
